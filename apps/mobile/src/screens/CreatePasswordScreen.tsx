...
const CreatePasswordScreen = () => {
    ...
    const handleNext = async () => {
        ...
        console.log('CreatePassword: Current params role:', role, typeof role);
        ...
        if (role?.toLowerCase() === 'service_provider') {
            ...
            console.log('CreatePasswordScreen: Navigating to ServiceProviderReview with:', navParams);
            navigation.navigate('ServiceProviderReview', navParams);
        } else if (role?.toLowerCase() === 'rental_owner') {
            const navParams = {
                ...params,
                email: params.email!,
                fullName: params.fullName!,
            ...
            console.log('CreatePasswordScreen: Navigating to RentalOwnerReview with:', navParams);
            navigation.navigate('RentalOwnerReview', navParams);
        } else {
            ...
            try {
                ...
                console.log('CreatePassword: Sending registration data:', JSON.stringify(registrationData, null, 2));
