    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Section title="Professional Profile" onEdit={handleEditProfessional}>
                    <Row label="Categories" value={professionalDetails.categories.join(', ')} />
                    <Row label="Experience" value={`${professionalDetails.yearsOfExperience} years`} />
                    <Row label="Skills" value={professionalDetails.skills.length > 0 ? professionalDetails.skills.join(', ') : 'None'} />
                </Section>

                {/* Documents */}
                <Section title="Documents" onEdit={handleEditDocuments}>
                    <Row label="National ID/Passport" value={documents.idImage ? "Attached" : "Missing"} />
                    <Row label="Certificates" value={`${documents.certificateImages.length} Attached`} />
